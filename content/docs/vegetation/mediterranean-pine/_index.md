...
- #### Valencia, Spain
  {{<figure src="aleppo-pine-es.png" caption="" class="img-lg" loading="lazy"
...
- #### Distribution
  {{<figure src="aleppo-pine-dist.png" caption="" class="img-lg" loading="lazy"
    link="https://www.inaturalist.org/observations?subview=map&taxon_id=82722" target="_blank">}}
...
- #### Aydin, Turkey
  {{<figure src="turkish-pine-tr.png" caption="" class="img-lg" loading="lazy"
...
- #### Distribution
  {{<figure src="turkish-pine-dist.png" caption="" class="img-lg" loading="lazy"
    link="https://www.inaturalist.org/observations?subview=map&taxon_id=135778" target="_blank">}}
...
- #### Landes, France
  {{<figure src="maritime-pine-fr.png" caption="" class="img-lg" loading="lazy"
...
- #### Distribution
  {{<figure src="maritime-pine-dist.png" caption="" class="img-lg" loading="lazy"
    link="https://www.inaturalist.org/observations?subview=map&taxon_id=82723" target="_blank">}}
...
- #### Andalusia, Spain
  {{<figure src="stone-pine-es.png" caption="" class="img-lg" loading="lazy"
...
- #### Distribution
  {{<figure src="stone-pine-dist.png" caption="" class="img-lg" loading="lazy"
    link="https://www.inaturalist.org/observations?subview=map&taxon_id=63621" target="_blank">}}

{{% /columns %}}


## Canary Island pine - [Pinus canariensis](https://en.wikipedia.org/wiki/Pinus_canariensis)

Long needles, which make the crown look a bit “fluffier” or more feathery compared to some other pines

{{% columns %}}

- #### Tenerife, Spain
  {{<figure src="canary-island-pine.png" caption="" class="img-lg" loading="lazy"
    link="https://www.google.com/maps/@28.167005,-16.635035,3a,106.3y,3.42h,130.28t/data=!3m5!1e1!3m3!1sY9l-CtwwFI4f8cvLtVIkPQ!2e0!6shttps%3A%2F%2Fstreetviewpixels-pa.googleapis.com%2Fv1%2Fthumbnail%3Fw%3D900%26h%3D600%26panoid%3DY9l-CtwwFI4f8cvLtVIkPQ%26cb_client%3Dmaps_sv.share%26yaw%3D3.4224527617609315%26pitch%3D-40.28235891655842%26thumbfov%3D106?coh=235716&entry=tts" target="_blank">}}
- #### Distribution
  {{<figure src="canary-island-pine-dist.png" caption="" class="img-lg" loading="lazy"
    link="https://www.inaturalist.org/observations?subview=map&taxon_id=47560" target="_blank">}}
