...
{{<figure src="no-ant.png" caption="" class="">}}

Kazakhstan, Oman, Ecuador, Rwanda

## Rattle Snake

{{<figure src="ant-rattlesnake.png" caption="" class="">}}

Senegal, Kazakhstan, Oman, UAE, Namibia, Kenya, Panama
...
{{<figure src="ant-rattlesnake-om.png" caption="lean right" class="img-lg"
...
{{<figure src="ant-rattlesnake-na.png" caption="lean left" class="img-lg"
...
{{<figure src="ant-down.png" caption="" class="">}}

Senegal, Kazakhstan, Oman, UAE, Panama
...
{{<figure src="ant-down-front.png" caption="Point front" class="img-lg"
...
{{<figure src="ant-screw.png" caption="" class="">}}

Kazakhstan

## Frame

{{<figure src="frame.png" caption="" class="">}}
...
{{<figure src="light.png" caption="" class="">}}
